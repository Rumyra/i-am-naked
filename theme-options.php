...
//Handle $_POST data after the form was saved
	...
	if (!current_user_can('manage_options'))  {
		wp_die( __('You do not have sufficient permissions to access this page.','i-am-naked') );
	}
	else{
		//If POST data was submitted, begin saving the options
			if ( isset($_POST['saved']) ){
			//Echo a confirmation message
				echo('<div class="updated"><p><strong>'. __('Your theme settings were saved.', 'i-am-naked' ) .'</strong></p></div>');
					...
					if ( isset($_POST['boilerplate_custom_logo_url'] ) && $_POST['boilerplate_custom_logo_url']!="" )
						//Validate the URL before saving this option. Display an error if invalid.
							if ( is_valid_url($_POST['boilerplate_custom_logo_url']) )
								...
								echo('<div class="error"><p><strong>'. __('The logo URL is invalid. Other settings were saved.', 'i-am-naked' ) .'</strong></p></div>');
					else
...
?>
<div class="wrap">
	<div id="icon-themes" class="icon32"><br/></div><h2><?php _e('Theme options','i-am-naked')?></h2>
	<form name="form1" method="post" action="">
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					<td colspan="2">
						<h3><?php _e('Dynamic title suffixes','i-am-naked')?></h3>
						<p>
							<?php _e(
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_dynamic_suffix"><?php _e("Use dynamic title suffixes", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row" colspan=2>
						<label for="txt_dynamic_suffix"><?php _e('Title suffixes to use:','i-am-naked')?></label>
				...
				<tr valign="top">
					<td colspan="2">
						<h3><?php _e('Dynamic meta description','i-am-naked')?></h3>
						<p>
							<?php _e(
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_dynamic_descriptions"><?php _e("Use dynamic meta descriptions", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<td colspan="2">
						<h3><?php _e('Human-readable dates','i-am-naked')?></h3>
						<p>
							<?php _e(
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_human_dates"><?php _e("Use human-readable dates", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<td colspan="2">
						<h3><?php _e('User menus','i-am-naked')?></h3>
						<p>
							<?php _e(
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_top_bar"><?php _e("Hide the admin top bar on the site", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_top_bar_logo"><?php _e("Remove the logo from the top admin bar", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_posts_menu"><?php _e("Hide Posts menu", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_pages_menu"><?php _e("Hide Pages menu", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_comments_menu"><?php _e("Hide Comments menu", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_media_menu"><?php _e("Hide Media menu", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_links_menu"><?php _e("Hide Links menu", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_profile_menu"><?php _e("Hide Profile menu", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_tools_menu"><?php _e("Hide Tools menu", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<td colspan="2">
						<h3><?php _e('File uploads','i-am-naked')?></h3>
						<p>
							<?php _e(
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_attachment_library"><?php _e("Hide the Media Library tab", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_attachment_caption"><?php _e("Hide the caption field", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_attachment_description"><?php _e("Hide the description field", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_attachment_link"><?php _e("Hide the URL field", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<td colspan="2">
						<h3><?php _e('Custom login image','i-am-naked')?></h3>
						<p>
							<?php _e(
				...
				<tr valign="top">
					<th scope="row">
						<label for="txt_logo_url"><?php _e("Logo URL (leave empty to disable)", 'i-am-naked' )?></label>
					</th>
					<td>
				...
				<tr valign="top">
					<td colspan="2">
						<h3><?php _e('"Comments disabled" message','i-am-naked')?></h3>
						<p>
							<?php _e(
				...
				<tr valign="top">
					<th scope="row">
						<label for="chk_hide_comments_disabled"><?php _e("Hide the \"Comments disabled\" message", 'i-am-naked' )?></label>
					</th>
					<td>
